...
help:
	@echo 'Management commands for DSiSc/contractsManage:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building contractsManage ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/contractsManage/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/contractsManage/version.BuildDate=${BUILD_DATE}" ./...
